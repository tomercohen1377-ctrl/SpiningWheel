...
import com.example.spinwheel.ui.SpinWheelGlanceWidget.Companion.ROTATION_KEY
...
fun WheelContent(
    ...
    Box(
        ...
        val rotatedWheel =
            if (rotationAngle != 0f) rotateBitmap(assets.wheel, rotationAngle) else assets.wheel
        Image(
