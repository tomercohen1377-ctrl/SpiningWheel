 ...
 *
 * Tapping the button triggers [LoadWheelActionCallback] which downloads
 * the JSON config + 4 images through the shared [com.example.spinwheel.di.SpinWheelGraph].
 */
@Composable
fun InitialContent() {
    Box(
